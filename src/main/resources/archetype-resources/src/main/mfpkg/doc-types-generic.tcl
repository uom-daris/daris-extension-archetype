...
proc create_doc_type_pssd_animal_modified_genetics { ns } {
...
proc create_doc_type_pssd_anaesthetic { ns } {
...
#============================================================================
proc create_doc_type_pssd_recovery { ns } {
...
proc create_doc_type_pssd_animal_kill { ns } {
...
#===========================================================================#
proc create_generic_doc_types { ns } {

	create_doc_type_pssd_animal_genetics $ns
	create_doc_type_pssd_animal_modified_genetics $ns
	create_doc_type_pssd_anaesthetic $ns
	create_doc_type_pssd_recovery $ns
	create_doc_type_pssd_animal_kill $ns
}

#===========================================================================#
proc destroy_generic_doc_types { ns } {
    
    destroy_doc_type $ns:pssd.animal.genetics
    destroy_doc_type $ns:pssd.animal.modified-genetics
    destroy_doc_type $ns:pssd.anaesthetic
    destroy_doc_type $ns:pssd.recovery
    destroy_doc_type $ns:pssd.animal.kill
}
