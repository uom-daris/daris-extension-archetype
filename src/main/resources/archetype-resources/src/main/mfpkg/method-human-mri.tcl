...
#                                                                            #
##############################################################################
proc create_method_human_mri { doc_ns { action 0 } { fillin 0 } } {
    set name "Human-MRI"
    set description "Human MRI acquisition"
    #
    ...
    set args "${margs} \
        ...
        :subject < \
            ...
            > \
            :private < \
                :metadata < :definition -requirement mandatory ${doc_ns}:pssd.human.identity > \
            > \
           > \
         > \
        :step < \
